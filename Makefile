...
lima:
	...
	@echo "" >> $(LIMA_YAML)
	@echo "# Minimal provision script to satisfy Lima boot check" >> $(LIMA_YAML)
	@echo "provision:" >> $(LIMA_YAML)
	@echo "- mode: system" >> $(LIMA_YAML)
	@echo "  script: |" >> $(LIMA_YAML)
	@echo "    #!/bin/bash" >> $(LIMA_YAML)
	@echo "    echo 'Immutablue VM ready'" >> $(LIMA_YAML)
	@echo "" >> $(LIMA_YAML)
