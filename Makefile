...
ifeq ($(REBOOT),1)
install_targets := ulimits install_brew install_distrobox install_flatpak post_install update_initramfs post_install_notes reboot
upgrade: rpmostree_upgrade reboot
else 
install_targets := ulimits install_brew install_distrobox install_flatpak post_install update_initramfs post_install_notes
