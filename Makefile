...
ifeq ($(REBOOT),1)
install_targets := install_brew install_flatpak post_install post_install_notes reboot
upgrade: rpmostree_upgrade reboot
else
install_targets := install_brew install_flatpak post_install post_install_notes
